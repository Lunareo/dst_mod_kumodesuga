...
---@field quotes string
---@field rarity string
---@field rarityorder number
---@field raritycolor table
---@field release_group number
---@field skin_tags table
---@field build_name_override string
---@field share_bigportrait_name string
---@field FrameSymbol string
---@field checkfn function
---@field checkclientfn function

---@param base string
---@param skinname string
---@param data skin_config
---@return ent
function MakeCharacterSkin(base, skinname, data)
    ...
    if not STRINGS.UI.RARITY[data.rarity] then
        ...
        SKIN_RARITY_COLORS[data.rarity] =
            data.raritycolor or { 0.635, 0.769, 0.435, 1 }
...
function basic_skininit_fn(inst, skinname)
    ...
    inst.AnimState:SetSkin(data.build or skinname, data.basebuild or inst.prefab or "")
    if data.anim then
...
if fninfo and fninfo.source and
    not fninfo.source:match("scripts/prefabskin%.lua") then
